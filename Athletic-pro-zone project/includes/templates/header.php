		...
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.php">
					<img class="logo"
						src="admin/layout/css/images/logo/Logo Files/For Web/png/White logo - no background.png">
				</a>
			</div>
			<div style="position:absolute;top: 6px;left: 650px;" class="collapse navbar-collapse" id="app-nav">
